...
import './home.css';
import TrainerLoginDialog from './TrainerLoginDialog';
...
export default function AppNoLogin() {
  ...
  return (
    <div>
        ...
        <div className="header-content">
          <nav>
            <ul className="menu">
              ...
              <li></li>
              <li><a href="/bim" onClick={(e) => { e.preventDefault(); handleNavigation('/bim'); }}>BMI</a></li>
              <li><a href="/tracker" onClick={(e) => { e.preventDefault(); handleNavigation('/tracker'); }}>TRACKER</a></li>
              <li><a href="/join-as-trainer" onClick={handleTrainerClick}>TRAINERS</a></li>
              <li><a href="/user-bookings" onClick={(e) => { e.preventDefault(); handleNavigation('/user-bookings'); }}>BOOKINGS</a></li>
      ...
      <TrainerLoginDialog isOpen={isTrainerDialogOpen} onClose={() => setTrainerDialogOpen(false)} />
    </div>
  );
}
