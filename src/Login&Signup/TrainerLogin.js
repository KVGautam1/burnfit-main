  ...
  const handleLogin = async (event) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        nav('/app-login-trainer'); // Navigate to AppLoginTrainer page on successful login
      } else {
    ...
    <div className="inter-container">
      ...
      <section className="hello">
        ...
        <div className={`wrapper-login ${formClass}`}>
          ...
          <p className="student-login-text">
             <a onClick={goToStudentLogin}>Student Login Here</a>
          </p>
        </div>
      </section>
    </div>
